1. Prueba local de la aplicación
...
La imagen se subió al repositorio público:
 insanejokajams/todo-api
 (docker build -t insanejokajams/todo-api:latest .
docker push insanejokajams/todo-api:latest)

Se probó la instalación local usando la imagen desde Docker Hub:
